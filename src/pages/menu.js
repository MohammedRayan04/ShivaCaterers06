      ...
      >
        ...
        {Object.keys(menuData).map((category, index) => (
          <div key={index} className="mb-6">
            <motion.div
              className="bg-slate-300 shadow-lg rounded-lg p-8 cursor-pointer transition-transform transform hover:scale-105"
            ...
            <AnimatePresence>
              {activeCategory === category && (
                <motion.div
                  className="border-zinc-50 shadow-lg rounded-lg p-4 mt-2 overflow-hidden"
                  initial="hidden"
                  animate="visible"
                  exit="hidden"
                ...
                >
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {menuData[category].map((item, i) => (
                      <motion.div
                        key={i}
                        className="bg-black p-4 rounded-lg shadow hover:shadow-lg font-bold text-white"
